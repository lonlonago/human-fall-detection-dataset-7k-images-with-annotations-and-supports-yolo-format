# Human Fall Detection Dataset 7K images with annotations and supports yolo format.

# Body

Human Fall Detection Dataset, 7K images with annotations, supports Yolo format
This dataset is suitable for projects such as fall detection and human behavior analysis. It is very comprehensive and can be directly used.
will be sent instantly upon purchase without refund or exchange.
